...
class HeadMovementDetector:
    ...
    def __init__(self):
        ...
        self.right_eye_indices = [362, 382, 381, 380, 374, 373, 390, 249, 263, 466, 388, 387, 386, 385, 384, 398]  # 右眼轮廓
    ...
    def detect_movement(self, image, frame_idx):
        ...
        if len(self.pitch_history) >= self.window_size:
            ...
            # 如果没有检测到动作，重置动作状态
            if abs(pitch_change) <= self.movement_threshold and abs(yaw_change) <= self.yaw_threshold:
    ...
    def save_action_frame(self, frame, movement, frame_idx):
        ...
        filename = f"{action_type}_{frame_idx:04d}_{timestamp}.jpg"
